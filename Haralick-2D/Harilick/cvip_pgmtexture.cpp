...
//void results (  float *Tp,char *c, float *a),  mkbalanced (), reduction (), simplesrt ();
//int hessenberg ();
//float f1_asm (  float **P,int Ng), f2_contrast (float**,int), f3_corr (), f4_var (), f5_idm (),
// f6_savg (), f7_svar (), f8_sentropy (), f9_entropy (), f10_dvar (),
// f11_dentropy (), f12_icorr (), f13_icorr (), f14_maxcorr (), 
//  *pgm_vector (), **pgm_matrix (int,int,int,int);
